...
export const Login: React.FC = () => {
  ...
  const fillDemoAccount = (role: UserRole) => {
    if (role === 'TOURIST') {
      ...
      setEmail('responder@safetour.app');
      setPassword('password123');
    } else {
          ...
          <div className="mt-8 pt-6 border-t border-slate-800/80">
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <button
                ...
                className="py-1.5 px-2 bg-slate-900 hover:bg-slate-800 border border-slate-800 rounded-lg text-[11px] font-semibold text-rose-400 transition-colors"
              >
                Responder
              </button>
              <button
                ...
                className="py-1.5 px-2 bg-slate-900 hover:bg-slate-800 border border-slate-800 rounded-lg text-[11px] font-semibold text-purple-400 transition-colors"
              >
                Admin
              </button>
            </div>
